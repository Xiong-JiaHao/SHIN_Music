...
import com.gin.xjh.shin_music.Interface.RequestServices_AlbumList;
...
public class getNetAlbumList {
    ...
    public void getJson(String id, View music_list_rv, View music_list_hint, Context mContext) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        RequestServices_AlbumList requestServices = retrofit.create(RequestServices_AlbumList.class);
